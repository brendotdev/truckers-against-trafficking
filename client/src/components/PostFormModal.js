  ...
  return (
    <div>
      ...
      >
        ...
        <MapModal
          isOpen={open} // Pass the open state to the MapModal
          onClose={handleClose} // Close the modal
          setSelectedLocation={setSelectedLocation} // Handle location selection
        />
        <DialogContent>
          <PostForm
            ...
            location={selectedLocation} // Pass the selected location to the PostForm
          />
        </DialogContent>
      </Dialog>
    </div>
